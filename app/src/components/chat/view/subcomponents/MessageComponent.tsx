    ...
    >
      {message.type === 'user' ? (
        ...
        <div className="flex w-full items-end space-x-0 sm:w-auto sm:max-w-[85%] sm:space-x-3 md:max-w-md lg:max-w-lg xl:max-w-xl">
          <div className="group flex-1 rounded-2xl rounded-br-md bg-white/10 px-3 py-2 text-foreground shadow-sm sm:flex-initial sm:px-4">
          ...
          {!isGrouped && (
            <div className="hidden h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-white/10 text-sm text-foreground sm:flex">
              U
            </div>
          )}
        </div>
        ...
        <div className="w-full">
          ...
          <div className="w-full">
            ...
            {message.isToolUse ? (
              ...
              // Optimistic assistant placeholder: shown immediately after the
