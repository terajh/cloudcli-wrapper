  ...
  return (
    <div className="ml-3 space-y-1 border-l border-border pl-3">
      ...
      {!initialSessionsLoaded ? (
        ...
        <div
          className="space-y-1 md:overflow-y-auto md:overscroll-contain md:rounded-md md:border md:border-border/50 md:bg-muted/40 md:p-1.5 md:pr-1 md:shadow-inner"
